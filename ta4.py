...
# ==========================================
# PERUBAHAN KRUSIAL: NO MORE LOG-TRANSFORM!
# ==========================================
# Kita skala miliaran menjadi angka belasan agar regresi linear sangat stabil (contoh: 11.5 Miliar jadi 11.5)
monthly_data['Total_Claim_B'] = monthly_data['Total_Claim'] / 1e9

# ==========================================
# 2. AUTOREGRESSIVE FEATURES (Kembali ke versi 5.5)
# ==========================================
def create_features(df):
    df = df.copy()
    df['Month'] = df['Date'].dt.month
    for col in ['Claim_Frequency', 'Total_Claim_B']:
        # KEMBALIKAN LAG 3 & 6 yang terbukti memberi skor 5.5
        for i in [1, 2, 3, 6]:
...
# Target sekarang adalah nilai nyata, BUKAN logaritma
targets = ['Claim_Frequency', 'Total_Claim_B']

# ==========================================
# 3. RECURSIVE ENSEMBLE TRAINING
# ==========================================
print("\nMelatih Model Recursive (The Raw Scale Revival)...")
current_ts_data = ts_data.copy()
final_preds = {'2025_08': {}, '2025_09': {}, '2025_10': {}, '2025_11': {}, '2025_12': {}}

# 1. Latih Holt-Winters SEKALI saja di awal
hw_preds_dict = {}
...
for i, pred_date in enumerate(months_to_predict):
    ...
    for target in targets:
        ...
        # BLENDING: Identik dengan skor 5.5
        ...
        # Simpan hasil untuk diexport
        target_name = 'Claim_Frequency' if target == 'Claim_Frequency' else 'Total_Claim'
        # Jika targetnya Total Claim, kembalikan skala 1 Miliar-nya
...
# ==========================================
submission_rows = []
print("\n--- HASIL PREDIKSI (RAW SCALE REVIVAL) ---")
...
print("\n[LOCKED] File 'submission_raw_scale_revival.csv' siap!")
print("Bias Logaritma telah dimusnahkan. Angka prediksi akan jauh lebih akurat menyentuh kunci jawaban! Gas < 3.0!")