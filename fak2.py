...
# KEMBALI KE CAPPING 98.0% (Kunci Absolut Skor 3.6)
# 99.0% terbukti membiarkan terlalu banyak noise yang merusak regresi.
...
# ---------------------------------------------------------
# THE SAFE IBNR PATCH (ANTI-LEDAKAN)
# ---------------------------------------------------------
...
if last_freq < 0.7 * prev_freq:
    ...
    # Daripada dikali 1.4x yang berisiko meledak, kita gunakan nilai rata-rata historis terdekat
    # Ini menjaga rantai waktu (Lag_1) tetap utuh namun angkanya sangat stabil
...
# ==========================================
# 3. ENSEMBLE TRAINING (RASIO EMAS 3.6 ABSOLUT)
# ==========================================
print("\nMelatih Model Recursive (The Safe IBNR Revival)...")
...
for i, pred_date in enumerate(months_to_predict):
    ...
    for target in targets:
        ...
        # Ridge alpha kembali ke 1.0 (Luwes menyerap tren seperti di skor 3.6)
        ...
        # BLENDING: Rasio Emas 3.6 (40% Bayes, 30% Ridge, 30% HW)
...
# ==========================================
submission_rows = []
print("\n--- HASIL PREDIKSI (THE SAFE IBNR REVIVAL) ---")
...
submission_df.to_csv('submission_safe_ibnr_revival.csv', index=False)
print("\n[LOCKED] File 'submission_safe_ibnr_revival.csv' siap!")
print("Capping kembali 98%. Rantai waktu disambung dengan rata-rata aman. Bismillah < 3.0!")