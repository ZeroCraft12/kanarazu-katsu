...
# ==========================================
print("\nMelatih Model Rekursif (The Interpolated Seasonal)...")
current_ts_data = ts_data.copy()
final_preds = {'2025_08': {}, '2025_09': {}, '2025_10': {}, '2025_11': {}, '2025_12': {}}

# Latih Holt-Winters Damped (+ PENGAMAN SEASONAL AKTIF!)
hw_preds_dict = {}
for target in targets:
    ...
    try:
        ...
        print(f"  -> [FALLBACK AKTIF] Data {target} kurang dari 24 bulan. Beralih ke Damped Non-Seasonal.")
        hw_fit = ExponentialSmoothing(
            hw_data, 
            trend='add', 
            seasonal=None,
...
submission_df.to_csv('submission_interpolated_seasonal.csv', index=False)
print("\n[LOCKED] File 'submission_interpolated_seasonal.csv' siap!")
print("Seasonal Holt-Winters resmi aktif tanpa crash. Persiapkan dirimu untuk < 3.0!")