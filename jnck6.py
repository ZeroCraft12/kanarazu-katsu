...
# ==========================================
# 4. THE ABSOLUTE ORACLE ENSEMBLE
# ==========================================
print("\nMelatih Model Rekursif (The Absolute Oracle)...")
...
for i, pred_date in enumerate(months_to_predict):
    ...
    for target in targets:
        ...
        # TRINITAS REGRESI (Model yang mencetak skor 3.6 di awal)
        ...
        # BLEND SUPER STABIL (Bebas Ledakan)
...
# ==========================================
submission_rows = []
print("\n--- HASIL PREDIKSI (THE ABSOLUTE ORACLE) ---")
...
submission_df.to_csv('submission_absolute_oracle.csv', index=False)
print("\n[LOCKED] File 'submission_absolute_oracle.csv' siap!")
print("Penyakit IBNR dihapus. AI memprediksi murni dari data solid. INI ADALAH TIKET KE < 3.0!")