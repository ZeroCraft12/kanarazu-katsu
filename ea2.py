...
# ==========================================
# 3. RECURSIVE ENSEMBLE TRAINING (GOLDEN BLEND)
# ==========================================
print("\nMelatih Model Recursive (The 3.6 Purist Form)...")
...
for i, pred_date in enumerate(months_to_predict):
    ...
    for target in targets:
        ...
        # THE SUB-3.0 GOLDEN BLEND: HW dinaikkan ke 40% agar lebih dominan menyetir tren!
        final_val = (0.35 * pred_bayes) + (0.25 * pred_ridge) + (0.40 * pred_hw)
...
# ==========================================
submission_rows = []
print("\n--- HASIL PREDIKSI (THE 3.6 PURIST FINAL) ---")
...
submission_df.to_csv('submission_sub3_purist.csv', index=False)
print("\n[LOCKED] File 'submission_sub3_purist.csv' siap!")
print("Kembali ke akar yang mencetak 3.6 dengan optimasi final. Mari jemput kepala 2!")