...
# THE < 3.0 CATALYST: CAPPING 99.0%
# Membiarkan 1% tagihan ekstra mahal masuk agar Mean/Rata-rata tebakan kita tidak kekecilan.
...
# ---------------------------------------------------------
# IBNR PATCH (KEMBALI KE 1.4x AGAR RANTAI WAKTU TIDAK PUTUS)
# ---------------------------------------------------------
...
if last_freq < 0.7 * prev_freq:
    print(f"\n[IBNR COMPLETION AKTIF] Menggenapkan data bulan terakhir x1.4 agar Lag_1 tidak melompat!")
...
# ==========================================
print("\nMelatih Model Recursive (The 3.6 Catalyst)...")
...
# ==========================================
submission_rows = []
print("\n--- HASIL PREDIKSI (THE 3.6 CATALYST) ---")
...
submission_df.to_csv('submission_the_catalyst.csv', index=False)
print("\n[LOCKED] File 'submission_the_catalyst.csv' siap!")
print("Rantai waktu tersambung kembali. Capping diangkat ke 99.0% untuk mendongkrak Mean. Bismillah < 3.0!")